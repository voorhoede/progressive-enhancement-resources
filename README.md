...
* [Text browsers](https://en.wikipedia.org/wiki/Text-based_web_browser): like [Lynx](http://lynx.browser.org/) good way to test if your content is accessible at the baseline.
