...
* [Modernizr](https://modernizr.com/): an extensive feature detection suite (supports custom builds).
* [Feature.js](http://featurejs.com/): a lightweight feature detection suite.
